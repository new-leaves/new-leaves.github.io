...
2. Vous devez écrire votre code dans le fichier <a href="/docs/td_1/skeleton.py"> skeleton.py</a>. Renommez ce fichier comme suivant <b>  <i>votrePrenom_votreNom.py</i></b>.
